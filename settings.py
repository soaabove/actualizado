...
SESSION_CONFIGS = [
    ...
    dict(
        name='taxexperiment',
        display_name="Tax experiment",
        num_demo_participants=3,
        app_sequence=['taxexperiment',],
    ),
    dict(
...
ROOMS = [
    dict(
        name='taxexperiment',
        display_name='Investigación de estudio',
        participant_label_file='_rooms/taxexperiment.txt',
    ),
...
SECRET_KEY = '0m=frzzqsr^bs%%qa4qmd!n%_6$-p@9-l9+y3_!&2q2@d)&l%$'
